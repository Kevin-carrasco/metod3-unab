...
| Caso 4                | 4          | 8         | 1      | 2     | 2                   | 1          |
| Caso 5                | 5          | 10        | 2      | 4     | 8                   | 4          |
| **Promedios / Sumas** | **X̄ = 3** | **Ȳ = 6** |        |       | **Σ = 20**          | **Σ = 10** |
...
| Caso 3                | 3          | 9         | 0      | 0     | 0                   | 0          |
| Caso 4                | 4          | 12        | 1      | 3     | 3                   | 1          |
| Caso 5                | 5          | 15        | 2      | 6     | 12                  | 4          |
| **Promedios / Sumas** | **X̄ = 3** | **Ȳ = 9** |        |       | **Σ = 30**          | **Σ = 10** |
...
| Caso 3                | 2          | 11         | 0      | 0     | 0               | 0          |
| Caso 4                | 3          | 14         | 1      | 3     | 3               | 1          |
| Caso 5                | 4          | 17         | 2      | 6     | 12              | 4          |
| **Promedios / Sumas** | **X̄ = 2** | **Ȳ = 11** |        |       | **Σ = 30**      | **Σ = 10** |
...
### Regresión lineal con variable dependiente participación en protestas
...
| Identificación política de izquierda (ref. Distinto de izquierda)                     | .150*** | [.091, .209]     |
...
### Regresión lineal con variable dependiente Satisfacción con la democracia

[https://revistadesociologia.uchile.cl/index.php/RDS/article/view/47884/50543](https://revistadesociologia.uchile.cl/index.php/RDS/article/view/47884/50543)

- Revisar sección resultados (página 43 en adelante)
