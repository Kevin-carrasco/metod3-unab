...
.right[
<br>
## .yellow[Sesión 8: Regresión logística (1)]
...
## 1. Introducción a regresión logística
...
.center[
```{r echo=FALSE,fig.height=6}
plot_lim1<-ggplot(data = tt, aes(x = as.numeric(sex), y = survived_n)) +
...
ggsave(plot_lim1, file="../../files/img/plot_lim1.png")
```

![:scale 95%](../../files/img/plot_lim1.png)
]
...
plot_lim2<-ggplot(data = tt, aes(x = age, y = survived_n)) +
  geom_point(aes(color = as.factor(survived_n)), shape = 1) +
  geom_smooth(method = "lm", color = "gray20", se = FALSE) +
  theme_bw()  +
  labs(title = "Regresión lineal por mínimos cuadrados",
       y = "Sobrevive") +
  theme(legend.position = "none", text = element_text(size = 20))
ggsave(plot_lim2, file="../../files/img/plot_lim2.png")
```

![:scale 95%](../../files/img/plot_lim2.png)
...
.pull-right[
```{r echo=FALSE, fig.height=6}
plot_lim3<-ggplot(data = tt, aes(x = age, y = survived_n2)) +
  ...
  labs(title = "Regresión lineal por mínimos cuadrados",
       y = "Sobrevive") +
theme(legend.position = "none", text = element_text(size = 20))
ggsave(plot_lim3, file="../../files/img/plot_lim3.png")
```

![:scale 95%](../../files/img/plot_lim3.png)
]
...
---
class: middle center
![:scale 90%](../../files/img/bending.png)
...
.pull-left[
```{r echo=FALSE}
ols_logit<-ggplot(data = tt, aes(x = age, y = survived_n2)) +
  geom_point(aes(color = as.factor(survived_n2)), shape = 1) +
  geom_smooth(method = "lm", color = "gray20", se = FALSE) +
  theme_bw()  +
  labs(title = "Regresión lineal por mínimos cuadrados",
       y = "Sobrevive") +
  theme(legend.position = "none", text = element_text(size = 20))
ggsave(ols_logit, file="../../files/img/ols_logit.png")
```

![:scale 95%](../../files/img/ols_logit.png)
]
...
```{r echo=FALSE}
ols_logit2<-ggplot(data = tt, aes(x = age, y = survived_n2)) +
  geom_point(aes(color = as.factor(survived_n2)), shape = 1) +
...
ggsave(ols_logit2, file="../../files/img/ols_logit2.png")
```

![:scale 95%](../../files/img/ols_logit2.png)
]
